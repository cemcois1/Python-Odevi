...
def textOlustur():
    ...
    for i in range(242):#255 ülke var datamda
...
def go (event):
    ...
    for i in i_secimim:#bana indexi döndürüyor
        ...
        #print(verim2[0])
            label=Label(top,text="Capital City = "+str( verim2[i]["city"]))
        ...
        for gezinen in range(994):#diller
            ...
            if(verim3[gezinen].get("country")==str(verim3[i]["country"]) ):#ekle
                #print("tamamdııır")
        ...
        label=Label(top,text="Abbreviation = "+str( verim3[i]["abbreviation"]))
        label.pack(side=TOP, anchor=NW)
