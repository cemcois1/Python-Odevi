...
mylinklist=[
    "src\country-by-capital-city.json",                #başkent
    "src\country-by-languages.json",                   #ülke dili
    "src\country-by-abbreviation.json",                #kısaltması
    "src\country-by-region-in-world.json" ,            #bulunduğu kıta
    "src\country-by-government-type.json" ,            #ülke tipi yönetimi
    "src\country-by-surface-area.json"   ,             #yüzey alanı
    "src\country-by-population.json",                  #nüfus
    "src\country-by-population-density.json",          #nüfus yogunlugu
    "src\country-by-independence-date.json" ,          #bagımsızlık yili
    "src\country-by-currency-name.json" ,              #para birimi adi
    "src\country-by-domain-tld.json",                  #kullandıgı domain
    "src\country-by-calling-code.json",                #alan kodu tr 90 
    "src\country-by-religion.json" ,                   #dini
    "src\country-by-yearly-average-temperature.json",  #yıllık ortalama sıcaklık 14 tane
    "src\country-by-flag.json"   
    ]
...
def textOlustur():
    ...
    with open('src\country-by-name.json') as f:
        verim=json.load(f)
